//! Private FIPS 180-4 SHA-512 (QK-DEC-048).
//!
...
mod tests {
    ...
    const SHORT_MSG: &[u8] = include_bytes!("../tests/fixtures/SHA512ShortMsg.rsp");
    const LONG_MSG: &[u8] = include_bytes!("../tests/fixtures/SHA512LongMsg.rsp");
    const MONTE: &[u8] = include_bytes!("../tests/fixtures/SHA512Monte.rsp");

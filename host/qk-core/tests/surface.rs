...
#[test]
fn product_closure_is_exactly_qk_core_plus_qk_ipc() {
    assert_eq!(
...
#[test]
fn production_sources_have_no_signer_wallet_export_apdu_socket_or_logging_api() {
    let sources = [LIB, CAPABILITY, ERROR, IO_WIRE, SESSION, SESSION_ID, WIPE];

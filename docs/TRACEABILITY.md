...
## Forward matrix (70 requirements)
...
| A1-006 | 008, 009 | 006, 016 | A1-001, A1-002, A1-003, A1-004, A1-005, A1-006, A1-007 | FUZZ-005, BENCH-003 | A |
| A1-007 | 004, 008 | 014 | NONE | AUD-006, HF-001 | A |
| A1-008 | 004 | 014 | NONE | AUD-006 | FOUNDATION |
| CARD-001 | 006 | 003, 008, 018 | NONE | BENCH-002, AUD-003 | B |
| CARD-002 | 006 | 001, 014 | NONE | REH-001, AUD-003 | B |
| CARD-003 | 006 | 003, 017 | NONE | UNIT-007, BENCH-002 | B |
| CARD-004 | 009 | 006, 016 | APDU-001, APDU-002, APDU-003, APDU-004, APDU-005, APDU-006, APDU-007 | FUZZ-004, CORP-005 | B |
...
| PSBT-005 | 009 | 006, 016 | PSBT-001, PSBT-002, PSBT-003, PSBT-004, PSBT-005, PSBT-006, PSBT-007, PSBT-008, PSBT-009, PSBT-010, PSBT-011, PSBT-012, PSBT-013, PSBT-014 | FUZZ-001, BENCH-003 | C |
...
| TRN-005 | 009 | 006, 016 | QR-001, QR-002, QR-003, QR-004, QR-005, QR-006, QR-007, QR-008, QR-009 | FUZZ-002, CORP-002 | A |
| TRN-006 | 009 | 006, 016 | SD-001, SD-002, SD-003, SD-004, SD-005, SD-006, SD-007 | FUZZ-003, BENCH-003 | C |
| TUI-001 | 010 | 007 | NONE | UNIT-007, AUD-001 | C |
| TUI-002 | 009, 010 | 006, 017 | NONE | PROP-002, HF-002 | C |
| TUI-003 | 009 | 012, 016 | TUI-001, TUI-002, TUI-003, TUI-004, TUI-005, TUI-006, TUI-007 | HF-002, BENCH-003 | C |
...
| PLT-006 | 009, 010 | 006, 016 | MEM-001, MEM-002, MEM-003, MEM-004, IPC-001, IPC-002, IPC-003, EXE-001, EXE-002 | BENCH-003, SAN-001 | C |
...
| 004 | A1-007, A1-008, CARD-007, PLT-001, PLT-007, ASR-009 |
| 005 | REC-001, REC-002, REC-003, REC-004, REC-006 |
| 006 | CARD-001, CARD-002, CARD-003, CARD-005, CARD-006, CARD-007, TUI-004, PLT-001, REC-004, REC-005 |
| 007 | CUS-002, ENT-001, ENT-002, ENT-003, ENT-004, ENT-005, HF-001 |
| 008 | A1-001, A1-002, A1-003, A1-004, A1-005, A1-006, A1-007 |
| 009 | A1-006, CARD-004, PSBT-001, PSBT-002, PSBT-003, PSBT-004, PSBT-005, PSBT-006, TRN-001, TRN-002, TRN-003, TRN-004, TRN-005, TRN-006, TUI-002, TUI-003, PLT-006, REC-005, HF-003 |
| 010 | PSBT-002, TRN-004, TUI-001, TUI-002, PLT-002, PLT-003, PLT-004, PLT-005, PLT-006, PLT-007 |
| 011 | CUS-007 |
...
## Reverse coverage — threats (19 of 20 covered; QK-THR-010 explicitly excluded)
...
| 006 | CUS-006, A1-003, A1-004, A1-006, CARD-004, PSBT-001, PSBT-002, PSBT-003, PSBT-004, PSBT-005, PSBT-006, TRN-001, TRN-003, TRN-004, TRN-005, TRN-006, TUI-002, PLT-003, PLT-004, PLT-005, PLT-006, HF-003, ASR-005 |
...
| 012 | CUS-005, CUS-007, ENT-003, ENT-005, TUI-003, REC-005, HF-001, HF-002, HF-003, HF-004, ASR-003, ASR-008 |
| 013 | ASR-001, ASR-006, ASR-010 |
| 014 | A1-007, A1-008, CARD-002, CARD-007, PLT-001, PLT-005, PLT-007, ASR-001, ASR-009 |
| 015 | CUS-002, ENT-001, ENT-002, ENT-003, ENT-004, ENT-005, A1-002 |
| 016 | A1-006, CARD-004, PSBT-001, PSBT-002, PSBT-005, TRN-001, TRN-003, TRN-005, TRN-006, TUI-003, PLT-006, HF-003, ASR-005 |
| 017 | CUS-006, A1-004, CARD-003, PSBT-006, TUI-002 |
| 018 | CARD-001, PLT-001, PLT-003, PLT-004, PLT-005 |
| 019 | CARD-005, TRN-002, REC-005 |
| 020 | CUS-004, CUS-007, REC-001, REC-006, HF-002 |

QK-THR-015…020 are append-only precision refinements added in the F1 audit-correction pass; their coverage restates coverage of the broad threats they refine.

## Reverse coverage — limits and planned tests (mechanically confirmed)

- All 60 QK-LIM rows defined in `docs/RESOURCE-BUDGETS.md` are cited by at least one requirement (60/60 at generation time; re-check with the procedure below).
- All 54 QK-TST IDs defined in `docs/TEST-ARCHITECTURE.md` are cited by at least one requirement (54/54 at generation time; re-check with the procedure below).
- Every limit and test ID cited by a requirement exists in its defining register (no dangling citations at generation time).

## Orphan check

At generation time, mechanically confirmed: every SHALL/SHALL NOT normative statement in the F1 document set lives in exactly one `docs/REQUIREMENTS.md` row with a QK-DEC source, threat citation, limit citation (or NONE with rationale), planned tests, and gate; the other F1 documents (this file, LIFECYCLE-STATES, RESOURCE-BUDGETS, TEST-ARCHITECTURE) contain no free-standing SHALL/SHALL NOT claims, only non-normative restatements by requirement ID.
...
3. Confirm every `QK-DEC-001…014` appears in the decision reverse table; every `QK-THR-001…020` appears in the threat reverse table as covered or explicitly excluded.
...
5. Confirm ID uniqueness across all families (sort/uniq, zero duplicates), that every requirement row has the expected Markdown field count with no unescaped table separators, and that every resource-budget Value/Status cell is the exact OPEN placeholder.
